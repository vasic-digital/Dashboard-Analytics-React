# CONSTITUTION — Dashboard-Analytics-React

Project-specific governance for the **Dashboard-Analytics-React** repository. This document carries the Universal Mandatory Constraints inherited from the cross-project root.
